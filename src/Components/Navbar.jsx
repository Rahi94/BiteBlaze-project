        ...
        <div>
            <div className="navbar bg-base-100 shadow-lg fixed z-10 px-4">
                <div className="flex-1">
                    <Link to='/' className="btn btn-ghost text-2xl font-bold gap-0 text-secondary normal-case">Bite <span className='text-primary'>Blaze</span></Link>
                </div>
                <div className="flex-none">
                    <ul className="menu menu-horizontal px-1 flex gap-6 mr-4">
